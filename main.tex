...
Think about the units of the information tensor and this derivative vector to make sure your expression is good.
\end{note}
...
\begin{note}
I conjecture that the effects will be largest when either $P_1$ approaches $P_2$ or else when both periods get comparable to the total time of the full observing campaign.
\end{note}
