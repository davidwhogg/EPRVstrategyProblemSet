...
\noindent
\textit{by} \textbf{David W. Hogg}\footnote{The author is very grateful for input from Niamh O'Sullivan (Oxford), Ryan Rubenzahl (CCA), and Megan Bedell (CCA).}
...
\begin{problem}[what if we can mitigate granulation?]
HOGG: Write this problem.
\end{problem}
